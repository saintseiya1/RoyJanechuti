...
function calculateData() {
	...
	document.getElementsByClassName('info__numbers--property_taxes')[0].innerHTML = 
		parseFloat(monthlyPropertyTaxes).toFixed(2)
	document.getElementsByClassName('info__numbers--home_insurance')[0].innerHTML = 
		parseFloat(monthlyHomeInsurance).toFixed(2)
...
function updateChart(chart, label, color) {
	...
	chart.options.transitions.active.animation.duartion = 0
	chart.update()
}
